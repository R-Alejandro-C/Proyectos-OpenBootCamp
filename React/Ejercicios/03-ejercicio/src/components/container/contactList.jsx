...
const ContactList = () => {
    ...
    const contacto1 = new contacto("Rodrigo", "Colcas", "Kailer3000.11", false)
    const contacto2 = new contacto("Rodrigo1", "Colcas1", "Kailer3000", true)
    const contacto3 = new contacto("Rodrigo2", "Colcas2", "Kailer.11", false)
    const contacto4 = new contacto("Rodrigo3", "Colcas3", "K3000.11", true)
